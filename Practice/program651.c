...
int main()
{
    ...
    while(1)
    {
        ...
        else if(iCount == 2)
        {
            ...
            {
                printf("\nEnter the data that you want to write into file\n");
                ...
                if(iRet == ERR_INVALID_PARAMETER)
                {
                    ...
                    printf("\nRefrer Man Page for more informatio\n");
                ...
                {
                    printf("\nError: There is no Permission to write the data\n");
                }
                else if(iRet == ERR_INSUFFICENT_SPACE)
                {
                    printf("\nError: There is no Space to write data\n");
                }
                else{
                    printf("%d bytes gets successfully stored into file ",iRet);
                }
            }
